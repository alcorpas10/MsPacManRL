...
class Game():
    ...
    def get_state(self):
        ...
        try:
            ...
            list_edible_ghosts = list(map(int, state_list[3].replace("[","").replace("]","").split(",")))       # get the edible tme of the nearests ghost  in each direction    
        ...
        # In case of error, send a string of gameover    
