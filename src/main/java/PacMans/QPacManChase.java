...
public class QPacManChase extends QPacMan {
    ...
    public void setNewGame(Game game) {
    	...
    	calculateStateDavid(distanceGhost, directionGhost);

    }
    public void setNewGameDavid(Game game) {
    	this.game = game;
    	this.lastJunctionMove = MOVE.LEFT;
  ...
  private void calculateStateDavid(int distanceGhost, MOVE directionGhost) {
    ...
    public void updateStrategyDavid() {
    	int msPacManNode = -1;
    	MOVE msPacManMove = null;
